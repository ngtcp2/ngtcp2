...
- GnuTLS >= 3.7.5
- BoringSSL (commit e575a84d5f051483793b14c07b60720d0ed318b3);
  or aws-lc >= 1.39.0
...
.. code-block:: shell
   ...
   $ cd boringssl
   $ git checkout e575a84d5f051483793b14c07b60720d0ed318b3
...
.. code-block:: shell
   ...
   $ git clone --depth 1 -b v1.66.1 https://github.com/aws/aws-lc
   $ cd aws-lc
